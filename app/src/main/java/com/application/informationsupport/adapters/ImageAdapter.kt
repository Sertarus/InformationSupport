...
class ImageAdapter (val context: Context, private val imageList: List<Bitmap>) : RecyclerView.Adapter<ImageAdapter.ImageHolder>() {
    ...
    override fun onBindViewHolder(holder: ImageHolder, position: Int) {
        ...
        holder.imageView.setImageBitmap(Bitmap.createScaledBitmap(image, 200, 200, false))
